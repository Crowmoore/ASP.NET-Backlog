...
namespace Backlog
{
    public static class Database
    {
        public static DataTable GetTestData()
        {
            ...
            table.Rows.Add("Testgame4", "30/30", "Mastered", "");
            table.Rows.Add("Testgame5", "30/30", "Mastered", "");
            table.Rows.Add("Testgame6", "30/30", "Mastered", "");
            table.Rows.Add("Testgame7", "30/30", "Mastered", "");
            table.Rows.Add("Testgame8", "30/30", "Mastered", "");
        ...
        public static bool AddUserToDatabase(string uid, string password, string email, string hash)
        {
            ...
            try
            {
                ...
                HttpContext.Current.Session["Error"] = "Could not complete registeration.";
                return false;
            }
            catch (Exception)
            {
